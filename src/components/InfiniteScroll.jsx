...
export default function InfiniteScroll({
  ...
  return (
    <div
      ...
      style={{ maxHeight }}>
      <div
        className="absolute top-0 left-0 w-full h-1/4 bg-gradient-to-b from-white to-transparent z-10 pointer-events-none"></div>
      <div
        className="absolute bottom-0 left-0 w-full h-1/4 bg-gradient-to-t from-white to-transparent z-10 pointer-events-none"></div>
      <div
        ...
        {items.map((item, i) => (
          <div
            className="flex items-center justify-center p-4 text-xl font-semibold text-center border-2 border-gray-300 rounded-[15px] select-none box-border relative"
            key={i}
            style={{
